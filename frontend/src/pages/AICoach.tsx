...
const weeklyInsightCards: Array<{
...
}> = [
  {
    ...
    pills: [
      { label: '-1:4.1 RR in open 30min', tone: 'red' },
      { label: '+1:7.3 RR after 10:15', tone: 'green' },
    ],
  },
  {
    badge: 'PSYCHOLOGY',
  ...
  },
  {
    ...
    body:
      "Trades taken 8:00-9:30 ET on NQ: 71% win rate, avg +1:1.6 RR, over 4 consecutive weeks. Your notes in these sessions use the word 'clear' significantly more than any other window. You are not replicating this process - you're just showing up earlier. Consider building a pre-session checklist specifically for this window.",
    pills: [
      { label: '71% W/R', tone: 'green' },
      { label: 'avg +1:1.6 RR', tone: 'green' },
  ...
  },
  {
    ...
    body:
      "On Tuesday and Thursday you increased position size on the trade immediately following a losing trade. Your notes don't mention this decision either time - which suggests it wasn't part of the plan. Both trades lost. Combined cost: -1:2.8 RR. This is a pattern worth making a rule around, not just noticing.",
    pills: [
      { label: '-1:2.8 RR combined', tone: 'red' },
...
const emotionalMatrix: Array<{
  ...
  { state: 'Confident', winRate: '71%', avgR: '+1:1.8 RR', avgTrades: '2.1', bestWindow: 'London-NY', winTone: 'good', rTone: 'good' },
  { state: 'Focused', winRate: '68%', avgR: '+1:1.6 RR', avgTrades: '2.4', bestWindow: 'Any', winTone: 'good', rTone: 'good' },
  { state: 'Neutral', winRate: '54%', avgR: '+1:0.8 RR', avgTrades: '3.1', bestWindow: 'Midday', winTone: 'neutral', rTone: 'neutral' },
  { state: 'Anxious', winRate: '38%', avgR: '-1:0.4 RR', avgTrades: '4.8', bestWindow: 'None', winTone: 'bad', rTone: 'bad' },
  { state: 'Frustrated', winRate: '29%', avgR: '-1:1.1 RR', avgTrades: '5.9', bestWindow: 'None', winTone: 'bad', rTone: 'bad' },
  { state: 'Need to make it back', winRate: '18%', avgR: '-1:2.1 RR', avgTrades: '7.2', bestWindow: 'None', winTone: 'bad', rTone: 'bad' },
];
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="rounded-[10px] border border-[#E24B4A]/30 bg-[#E24B4A]/10 p-5">
            ...
            <p className="mt-3 text-[14px] leading-[1.7] text-[#8A8F98]">
              You lost -1:2.1 RR yesterday. Historically you lose money in 7 of 9 sessions the day after a loss above
              -1:1.5 RR. Consider sizing down by 50% for the first 2 trades.
            </p>
...
function RightPanel({
  ...
  const rightPanelStats = [
    { label: 'Net RR', value: '+1:3.2 RR', detail: '', valueClass: 'text-[#00C97A]' },
    { label: 'Win rate', value: winRateText, detail: winRateDetail, valueClass: 'text-white' },
    { label: 'Avg winner', value: '+1:1.8 RR', detail: '', valueClass: 'text-[#00C97A]' },
    { label: 'Avg loser', value: '-1:0.9 RR', detail: '', valueClass: 'text-[#E24B4A]' },
  ];
